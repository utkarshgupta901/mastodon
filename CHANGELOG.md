...
- **Add editing for published posts** (#16697, #17727, #17728, #17320, #17404, #17390, #17335, #17696)
- **Add appeals** (#17364, #17725, #17566)
- **Add notifications for posts deleted by moderators** (#17204, #17668)
- **Add explore page** (#17123, #17431, #16917, #17677, #16938)
- Add graphs and retention metrics to admin dashboard (#16829, #17617, #17570, #16910, #16909, #16884)
- Add `GET /api/v1/accounts/familiar_followers` to REST API (#17700)
- Add `POST /api/v1/accounts/:id/remove_from_followers` to REST API (#16864)
- Add `category` and `rule_ids` params to `POST /api/v1/reports` IN REST API (#17492)
- Add global `lang` param to REST API (#17464, #17592)
- Add notifications for moderators about new sign-ups (#16953)
- Add authentication history (#16408, #16428)
- Add ability to automatically delete old posts (#16529, #17691, #16653)
- Add ability to pin private posts (#16954)
- Add ability to filter search results by author using `from:` syntax (#16526)
- Add ability to delete canonical email blocks in admin UI (#16644)
- Add ability to purge undeliverable domains in admin UI (#16686, #17210, #17741, #17209)
- Add ability to disable e-mail token authentication for specific users in admin UI (#16427)
- Add ability to suspend accounts in batches in admin UI (#17009)
- Add ability to filter reports by origin of target account in admin UI (#16487)
- Add support for login through OpenID Connect (#16221)
- Add lazy loading for emoji picker in web UI (#16907)
- Add single option votes tooltip in polls in web UI (#16849)
- Add confirmation modal when closing media edit modal with unsaved changes in web UI (#16518)
- Add support for fetching Create and Announce activities by URI in ActivityPub (#16383)
- Add `S3_FORCE_SINGLE_REQUEST` environment variable (#16866)
- Add `OMNIAUTH_ONLY` environment variable (#17288)
- Add ability to pass specific domains to `tootctl accounts cull` (#16511)
- Add `--by-uri` option to `tootctl domains purge` (#16434)
- Add `--batch_size` option to `tootctl search deploy` (#17049)
- Add `--remove-orphans` option to `tootctl statuses remove` (#17067)
...
- Change authorized applications page (#17656, #17686)
- Change e-mail domain blocks to block IPs dynamically (#17635)
- Change report modal to include category selection in web UI (#17565)
- Change actions in reports to require only one click in admin UI (#17487)
...
- Change routing paths to use usernames in web UI (#16171, #16772)
- Change list title input design in web UI (#17092)

### Removed

- Remove profile directory link from main navigation panel in web UI (#17688)
- **Remove language detection through cld3** (#17478, #17539)
- Remove support for `OAUTH_REDIRECT_AT_SIGN_IN` (#17287)
- **Remove Keybase integration** (#17045)
- Remove old columns and indexes (#17245, #16409, #17191)
- Remove shortcode from newly-created media attachments (#16730)

### Fixed

- Fix subscribed relay activities being recorded as boosts (#17571)
- Fix streaming API server error messages when JSON parsing fails not specifying the source (#17559)
- Fix browsers autofilling new password field with old password (#17702)
- Fix text being invisible before fonts load in web UI (#16330)
- Fix public profile pages of unconfirmed users being accessible (#17385)
